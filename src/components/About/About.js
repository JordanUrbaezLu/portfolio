...
import { FaReact, FaChess, FaBook, FaRunning, FaNutritionix } from 'react-icons/fa';
    ...
    return (
        <div className="About">
            <div className="profile">
                <img src={picture} alt="Jordan Urbaez Lu"></img>
                <div className="name">Jordan Urbaez Lu</div>
                <div className="description">
                    I am a Senior Front-End Developer who specializes in React Development. 
                    I have been in the field for over 4 years using industry leading technolgies 
                    such as HTML5, CSS3, SASS, JavaScript, ES6, JSON, React, TypeScript, Redux, 
                    Node.js, jQuery, Jest, Enzyme, Express, Webpack, MongoDB, and many more. 
                    I am also well experienced building effective React applications using concpets like React Router, React Hooks, 
                    JSX, Functional Components, Component Life Cycles, Context Api, React Redux, Server-Side Rendering, and more.
                </div>
            </div>
